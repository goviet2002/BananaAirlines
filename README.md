### This is my project at the university where I had to build an airline website built on a database connected to MariaDB! 

#### To connect with MariaDB you have to load the bananaairlines.sql into HeidiSQL and adjust your password and database name of code in app.py (lines 13-14) according to your database.
...
#### The website can also be integrated by an employee where he can deal with cancel requests, and add, edit, or remove flights and tiers via login with an account that I already created (admin_boss 123).
